namespace MyTLUServer.Application.DTOs
{
    ...
    {
        // Khởi tạo các thuộc tính phức tạp bằng 'null!'
        // để báo cho C# biết chúng sẽ được gán giá trị sau.
        public LecturerStatsDto Stats { get; set; } = null!;
        
        // Khởi tạo các collection (danh sách) bằng List rỗng
    ...
    // 2. DTO cho Stats (Không cần sửa vì chỉ có kiểu 'int' - value type)
    ...
    {
        public int ClassSessionId { get; set; }
        public string ClassName { get; set; } = null!; // Gán null!
        public string SessionTitle { get; set; } = null!; // Gán null!
        public DateTime StartTime { get; set; }
        public DateTime EndTime { get; set; }
        public string Location { get; set; } = null!; // Gán null!
        public string AttendanceStatus { get; set; } = null!; // Gán null!
    }

    // 4. DTO cho Lớp đang dạy
    public class TeachingClassDto
    {
        public string ClassCode { get; set; } = null!; // Gán null!
        public string ClassName { get; set; } = null!; // Gán null!
        public string Tag { get; set; } = null!; // Gán null!
    }

    // 5. DTO cho Điểm danh gần đây
    public class RecentAttendanceDto
    {
        public string Subject { get; set; } = null!; // Gán null!
        public string ClassCode { get; set; } = null!; // Gán null!
        public string SessionTitle { get; set; } = null!; // Gán null!
        public DateTime SessionDate { get; set; }
        public string? CheckInTime { get; set; } // Cho phép null (dùng ?)
        public int PresentCount { get; set; }
        public string AttendanceRate { get; set; } = null!; // Gán null!
    }
}