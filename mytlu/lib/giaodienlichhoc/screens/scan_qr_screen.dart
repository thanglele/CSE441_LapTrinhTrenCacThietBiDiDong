...
class _ScanQRScreenState extends State<ScanQRScreen> {
    ...
    if (result.isPermanentlyDenied) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: const Text('Bạn cần cấp quyền Camera trong cài đặt để quét mã QR.'),
            actions: [
              TextButton(
                onPressed: () {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Vui lòng cho phép quyền Camera để quét mã QR.'),
 ...
 // ...existing helper widgets (none) ...
   ...
   BottomNavigationBarItem _buildNavItem(IconData icon, String label, bool active) {
